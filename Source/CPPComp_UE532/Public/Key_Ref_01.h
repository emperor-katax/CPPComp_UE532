...
#include "Key_Ref_01.generated.h"

class exampleClass_00;

UCLASS()
class CPPCOMP_UE532_API AKey_Ref_01 : public AActor{
	GENERATED_BODY()
...
public:	
	...
	// outside 
	exampleClass_00* object_A1;
	exampleClass_00* object_A2;

	// inline
	class anotherClass_01* object_B1;
	class anotherClass_02* object_B2;
...
public:	
	...
	// https://dev.epicgames.com/documentation/en-us/unreal-engine/text-localization-in-unreal-engine?application_version=5.3
